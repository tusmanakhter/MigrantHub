...
router.get('/', controllerHandler(ServiceController.getServices, req => [req.query.editOwner, req.query.searchQuery, req.query.search, req.query.category, req.query.subcategory, req.cookies.locale, req.query.offset, req.query.limit, req.query.filtered]));
