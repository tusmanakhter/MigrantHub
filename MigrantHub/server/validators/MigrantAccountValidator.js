...
function MigrantAccountValidator(migrantObject){
    ...
    }else if (!validator.isBoolean(migrantObject.lookingForJob)) {
    ...
    if (!validator.isEmpty(migrantObject.currentIncome) && !validator.isDivisibleBy(migrantObject.currentIncome, 1) && migrantObject.currentIncome < 0) {
