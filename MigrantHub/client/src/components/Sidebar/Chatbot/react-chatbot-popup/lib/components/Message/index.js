...
var _HTMLDiv = require('../HTMLDiv');

var _HTMLDiv2 = _interopRequireDefault(_HTMLDiv);
...
var Message = function (_React$PureComponent) {
  ...
  _createClass(Message, [{
    ...
    value: function render() {
      ...
      var sanitizedHTML = _marked2.default.parse(text, { sanitize: true });
      return React.createElement(
        _Div2.default,
        { style: _extends({}, _styles2.default.message[this.props.message.sender], { height: this.state.height || 'auto', paddingVertical: 10 }) },
        React.createElement(_HTMLDiv2.default, { HTML: sanitizedHTML, onChangeHeight: this.onChangeHeight, target: this.props.message.sender })
      );
    }
  }]);
